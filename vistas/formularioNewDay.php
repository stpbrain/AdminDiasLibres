...
<h2>Formulario de ingrese de Dias Adeudados</h2>
</div>

<div class="container">
<form action="../control/insertaNewDay.php" method="POST" name="form">
  <table class="table text-center">
    <tr >
      <th colspan="2" class="text-center" > Su usuario rut es <?php echo $rut ?></th>
      <input type="text" name="user" value="<?php echo $rut ?>" style="display: none;">
    </tr>
    <tr>
        <td>
